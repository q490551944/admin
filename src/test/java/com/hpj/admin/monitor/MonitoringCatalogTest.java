    ...
    void isolatedContextStartsWithoutInitializingAnyClientRegardlessOfChat(boolean monitorEnabled, boolean chatEnabled) {
        new ApplicationContextRunner().withUserConfiguration(MonitoringConfiguration.class, LazyClients.class)
                ...
                .run(context -> {
                    ...
                    assertThat(context.getBean(MonitoringAdapterRegistry.class).find(MiddlewareType.REDIS))
                            .hasValueSatisfying(adapter -> assertThat(adapter).isInstanceOf(RedisMonitoringAdapter.class));
                    assertThat(context.getBean(MonitoringAdapterRegistry.class).find(MiddlewareType.KAFKA))
                    ...
                    assertThat(context.getBean(MonitoringAdapterRegistry.class).find(MiddlewareType.MINIO))
                            .hasValueSatisfying(adapter -> assertThat(adapter).isInstanceOf(MinioMonitoringAdapter.class));
